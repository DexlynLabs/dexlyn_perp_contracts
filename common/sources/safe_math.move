module dexlyn::safe_math {
    ...
    /// WARNING: This lacks range assertion
    ...
    /// @dev Returns 10 to the power of b.
    public fun exp_of_10(b: u64): u64 {
        let c = 1;
        assert!(b <= 18, OVER_FLOW);
    ...
    /// x * y / z
    public fun safe_mul_div_u128(x: u128, y: u64, z: u64): u64 {
        if ( z == 0) {
